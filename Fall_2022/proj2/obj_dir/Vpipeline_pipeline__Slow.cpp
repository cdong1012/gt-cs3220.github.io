...
void Vpipeline_pipeline::_initial__TOP__pipeline__1(Vpipeline__Syms* __restrict vlSymsp) {
    ...
    __Vtemp1[1U] = 0x61646469U;
    __Vtemp1[2U] = 0x7274322fU;
    __Vtemp1[3U] = 0x732f7061U;
    __Vtemp1[4U] = 0x74657374U;
    __Vtemp1[5U] = 0x6f6a322fU;
    __Vtemp1[6U] = 0x322f7072U;
    __Vtemp1[7U] = 0x5f323032U;
    __Vtemp1[8U] = 0x46616c6cU;
    __Vtemp1[9U] = 0x2e696f2fU;
    __Vtemp1[0xaU] = 0x74687562U;
    __Vtemp1[0xbU] = 0x302e6769U;
    __Vtemp1[0xcU] = 0x73333232U;
    __Vtemp1[0xdU] = 0x67742d63U;
    __Vtemp1[0xeU] = 0x746f702fU;
    __Vtemp1[0xfU] = 0x4465736bU;
    __Vtemp1[0x10U] = 0x7865732fU;
    __Vtemp1[0x11U] = 0x6f73626fU;
    __Vtemp1[0x12U] = 0x6f6d652fU;
    __Vtemp1[0x13U] = 0x2f68U;
    ...
    __Vtemp2[1U] = 0x61646469U;
    __Vtemp2[2U] = 0x7274322fU;
    __Vtemp2[3U] = 0x732f7061U;
    __Vtemp2[4U] = 0x74657374U;
    __Vtemp2[5U] = 0x6f6a322fU;
    __Vtemp2[6U] = 0x322f7072U;
    __Vtemp2[7U] = 0x5f323032U;
    __Vtemp2[8U] = 0x46616c6cU;
    __Vtemp2[9U] = 0x2e696f2fU;
    __Vtemp2[0xaU] = 0x74687562U;
    __Vtemp2[0xbU] = 0x302e6769U;
    __Vtemp2[0xcU] = 0x73333232U;
    __Vtemp2[0xdU] = 0x67742d63U;
    __Vtemp2[0xeU] = 0x746f702fU;
    __Vtemp2[0xfU] = 0x4465736bU;
    __Vtemp2[0x10U] = 0x7865732fU;
    __Vtemp2[0x11U] = 0x6f73626fU;
    __Vtemp2[0x12U] = 0x6f6d652fU;
    __Vtemp2[0x13U] = 0x2f68U;
...
void Vpipeline_pipeline::_settle__TOP__pipeline__4(Vpipeline__Syms* __restrict vlSymsp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+      Vpipeline_pipeline::_settle__TOP__pipeline__4\n"); );
    Vpipeline* const __restrict vlTOPp VL_ATTR_UNUSED = vlSymsp->TOPp;
    // Body
...
void Vpipeline_pipeline::_ctor_var_reset() {
    ...
    __PVT__from_AGEX_to_FE = VL_RAND_RESET_Q(33);
    ...
    __PVT__my_DE_stage__DOT__reg_busy_bits_DE = VL_RAND_RESET_I(32);
    ...
    __PVT__my_AGEX_stage__DOT__br_cond_AGEX = VL_RAND_RESET_I(1);
    __PVT__my_AGEX_stage__DOT__wr_reg_AGEX = VL_RAND_RESET_I(1);
    __PVT__my_AGEX_stage__DOT__regval_AGEX = VL_RAND_RESET_I(32);
    __PVT__my_AGEX_stage__DOT__busy_bits_AGEX = VL_RAND_RESET_I(32);
    { int __Vi0=0; for (; __Vi0<16384; ++__Vi0) {
    ...
    __PVT__my_MEM_stage__DOT__busy_bits_MEM = VL_RAND_RESET_I(32);
    __Vtableidx1 = 0;
    __Vtablechg1[0] = 0U;
    __Vtablechg1[1] = 1U;
    __Vtablechg1[2] = 1U;
